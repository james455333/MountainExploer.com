									...
									<div class="d-flex">
										<div class="col-md-4 justify-content-end d-flex align-items-center ">
											...
											<div class="input-group">
												...
												<form class="form-inline" action="<c:url value='/Rout/mountainCampBack/selectAll'></c:url>"method='get'>
										...
										<div class="ml-auto">
											<form action="<c:url value='/Rout/mountainCampBack/selectAll'></c:url>"method='get'>					
												<input type="hidden" value="" name="selectarea" >
												<input type="hidden" value="" name="selectcounties" >
