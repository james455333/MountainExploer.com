...
<!-- 星星結束 -->
				...
				<nav class="pageControl">
					...
					<ul style="display: inline-flex;">
						...
						<c:otherwise><li class="li1"><a href="actselectAll?selectarea=${selectarea }&selectcounties=${selectcounties}&no=${no }&page=${page-1}">‹上一頁</a></li></c:otherwise>
						</c:choose>
					<li class="li1">
					<select onChange="location = this.options[this.selectedIndex].value">
						...
						<c:otherwise><li class="li1"><a href="actselectAll?selectarea=${selectarea }&selectcounties=${selectcounties}&no=${no }&page=${page+1}">下一頁›</a></li></c:otherwise>
						</c:choose>
