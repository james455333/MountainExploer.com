...
CREATE TABLE area (
    id    NUMBER(3)
        GENERATED ALWAYS AS IDENTITY ( START WITH 200 MINVALUE 200 MAXVALUE 299 NOCACHE ORDER )
    NOT NULL,
...
CREATE TABLE counties (
    id       NUMBER(4)
        GENERATED ALWAYS AS IDENTITY ( START WITH 2000 MINVALUE 2000 MAXVALUE 2999 NOCACHE ORDER )
    NOT NULL,
...
CREATE TABLE house_basic (
    id                NUMBER(5)
        GENERATED ALWAYS AS IDENTITY ( START WITH 26000 MINVALUE 26000 MAXVALUE 29999 CYCLE CACHE 10 ORDER )
    NOT NULL,
